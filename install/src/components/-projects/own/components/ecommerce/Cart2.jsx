     ...
     return ( 
       ...
       initial={{
        ...
        key={item.id} className='flex py-2 shadow-md hover:scale-[1.025] transition hover:shadow-lg cursor-pointer items-center'>
             ...
             <h1 className='sm:ml-24 ml-12 w-[25%]'>${Math.round(item.price-item.price*(item.discountPercentage/100))}</h1>
             <div className='h-[50%] flex gap-2 items-center sm:ml-16 ml-8 w-[25%]'>
               <h1>{item.quantity}</h1>
             ...
             <h1 className='sm:ml-24 ml-5 '>${total(item)}</h1>
          ...
          <div className='flex flex-col gap-20'>
            ...
            <div className='flex lg:flex-row flex-col items-center lg:justify-between gap-32 lg:gap-0 lg:items-start '>
                <div className='flex items-center justify-center gap-4'>
                    ...
                    <button className='py-4 px-4 sm:px-12 bg-[#db4444] shadow-md hover:bg-opacity-95 hover:shadow-lg active:scale-95 transition-all text-[#fafafa]'>Apply Coupon</button>
                </div>
                <div className='flex flex-col border border-[#212121] px-8 gap-3 py-5 w-[80%] lg:w-[40%]'>
                    ...
                    <Link className='sm:w-[80%] w-full mx-auto' to="/project/OWN/E-commerce/cart/checkout"><button className='py-4 sm:px-12 bg-[#db4444] shadow-md hover:bg-opacity-95 mt-10 hover:shadow-lg w-full active:scale-95 transition-all text-sm text-[#fafafa]'>Proceed to checkout</button></Link>
                </div>
            </div>
          </div>
       </div>
