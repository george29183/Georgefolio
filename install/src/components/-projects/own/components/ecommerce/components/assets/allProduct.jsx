const all_products = [
    {
      ...
      },
      {
        ...
        },
        {
          ...
          description: "Fair & Clear is Pakistan's only pure Freckle cream which helps fade Freckles, Dark spots and pigments. Mercury level is 0%, so there are no side effects.",
          price: 70,
      ...
      },
      {
        ...
        description: "Rattan Outdoor furniture Set Waterproof. Rattan Sofa for Coffee Cafe.",
        price: 50,
        quantity:0,
        isFavourite:false,
      ...
      },
      {
        id: 34,
        title: "Plastic Table",
        description: "Very good quality plastic table for multi-purpose. Now at a reasonable price.",
        price: 50,
      ...
      },
      {
        ...
        description: "Women winter clothes thick fleece hoodie top with sweat pant jogger women sweatsuit set joggers pants two-piece pants set",
        price: 57,
      ...
      },
      {
        ...
        description: "FABRIC: LILEIN CHEST: 21 LENGTH: 37 TROUSER: (38) :ARABIC LILEIN",
        price: 80,
        quantity:0,
        isFavourite:false,
