...
function YoutubeSmallScreenAside() {
 ...
 <motion.div  initial={{
    ...
    transition={{
        duration:0.1,
        ease:"easeInOut"
    }} className={`  h-full  left-0 flex gap-1 flex-col  text-xs items-center group text-slate-50  bg-[#0F0F0F]  z-[100] overflow-hidden fixed top-16 px-2  w-64 `}>
      ...
      <div className={`hover:overflow-y-auto px-3  flex flex-col gap-2 w-full h-full`}>
